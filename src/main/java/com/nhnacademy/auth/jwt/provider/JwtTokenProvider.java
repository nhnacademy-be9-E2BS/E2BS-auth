...
public class JwtTokenProvider {
	...
	/**
	 * Header, Payload, Signature 중 JWT 토큰의 Header 를 만드는 메서드
	 */
	private Map<String, Object> createHeader() {
		Map<String, Object> header = new HashMap<>();
		header.put("typ", "JWT"); // 토큰의 타입이 JWT 라는 것을 명시
	...
	/**
	 * Header, Payload, Signature 중 JWT 토큰의 Payload 를 만드는 메서드
	 * Claim 에는 토큰을 발급받은 주체에 대한 데이터를 담고 있다
	 * 사용자의 정보나 권한 같은 데이터
	 */
